        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Father</h4>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <!-- Left aligned Add button and search -->
                                <a href="{{ route('review.create') }}" class="btn btn-primary ms-3">
                                    Add
                                ...
                                <tbody>
                                    @foreach ($reviews as $review)
                                        <tr>
                                            ...
                                            <td><strong>{{ $review->father->name }}</strong></td>
                                            ...
                                            <td><strong>
                                                ...
                                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2"
                                                    ...
                                                    data-bs-target="#deleteSliderModal{{ $review->id }}">
