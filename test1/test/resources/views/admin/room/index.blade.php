                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="{{ route('room.create') }}" class="btn btn-primary ms-3">
                                    Add
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="myTable" class="table table-striped table-bordered text-center mx-3">
                                    <thead>
                                        <tr>
                                            <th><strong>#</strong></th>
                                            <th><strong>number_of_seats</strong></th>
                                            <th><strong>age_of_kids</strong></th>
                                            <th><strong>description</strong></th>
                                            <th><strong>name</strong></th>
                                            <th><strong>class_time</strong></th>
                                            <th><strong>Tution_Fee</strong></th>
                                    ...
                                    <tbody>
                                        @foreach ($rooms as $room)
                                            <tr>
                                                ...
                                                <td><strong>{{ $room->number_of_seats }}</strong></td>
                                                <td><strong>{{ $room->age_of_kids }}</strong></td>
                                                <td><strong>{{ $room->description }}</strong></td>
                                                <td><strong>{{ $room->name }}</strong></td>
                                                <td><strong>{{ $room->class_time }}</strong></td>
                                                <td><strong>{{ $room->Tution_Fee }}</strong></td>
                                                <td>
                                                    ...
                                                    <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2"
                                                        ...
                                                        data-bs-target="#deleteSliderModal{{ $room->id }}">
