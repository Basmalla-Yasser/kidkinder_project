                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="{{ route('teacher.create') }}" class="btn btn-primary ms-3">
                                    Add
                                ...
                                <tbody>
                                    @foreach ($teachers as $teacher)
                                        <tr>
                                            ...
                                            <td><strong>{{ $teacher->twitter }}</strong></td>
                                            <td><strong>{{ $teacher->linkedin }}</strong></td>
                                            <td><strong>{{ $teacher->facebook }}</strong></td>
                                            <td><strong>{{ $teacher->subject->name }}</strong></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2"
                                                    ...
                                                    data-bs-target="#deleteSliderModal{{ $teacher->id }}">
