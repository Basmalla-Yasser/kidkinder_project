                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter name"
                            style="font-size: 1.1rem;" value="{{ $blog->name }}">
                            @error('name')
        ...
        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="description" name="description"
                            placeholder="Enter  description" style="font-size: 1.1rem;" value="{{ $blog->description }}">
                            @error('description')
            <div class="text-danger">{{ $message }}</div>
        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <img id="currentImage" style="width: 70px;"
                            src="{{ asset('Gallary_image/attachments/Gallary_attachments/' . $blog->image) }}"
                            alt="not found"><br><br>
