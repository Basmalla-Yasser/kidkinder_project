      ...
      <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
          ...
          KidKinder is an innovative educational system designed
                        ...
                        The system focuses on offering advanced educational tools that combine educational games interactive activities.
          </p>
    ...
    >
      <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="/class"
            ...
            >
            <a class="text-white mb-2" href="/blogs"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="#">KidKinder</a>.
          All Rights Reserved.
          ...
          <a class="text-primary font-weight-bold" href="https://htmlcodex.com"
            >Basmalla Yasser Hussien Said Abdelrahman Ahmed</a
          >
